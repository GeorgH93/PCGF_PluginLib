...
public class BukkitSubCommand extends at.pcgamingfreaks.Command.SubCommand<TestBukkitPlayer>
{
	public boolean canUse = false;

	public BukkitSubCommand(@NotNull String name, @NotNull String description, @Nullable String permission, @Nullable String[] aliases)
	{
