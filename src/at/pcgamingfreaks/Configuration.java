...
public class Configuration
{
	...
	private void loadConfig()
	{
		try
		{
			if(!configFile.exists())
			{
				...
				try (InputStream is = getClass().getResourceAsStream(CONFIG_PATH); OutputStream os = new FileOutputStream(configFile))
				{
	...
	private void upgradeConfig()
	{
		try
		{
			...
			loadConfig();
			doUpgrade(new Configuration(log, configBaseDir, oldVersion, CONFIG_PATH + ".old_v" + oldVersion));
		}
		catch(Exception e)
		{
			e.printStackTrace();
